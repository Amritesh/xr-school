...
const SIMULATIONS = [
  ...
  {
    id: 'sim-nutrition-in-plants-secret-kitchen-001',
    ...
    simulationFormat: 'immersiveVr',
    xrFitType: 'strongVrFit',
    xrFitJustification: 'The immersive journey enlarges invisible plant structures and transport processes for direct spatial inspection.',
    learningObjective: 'Students will explain photosynthesis and trace water and food transport through xylem and phloem.',
    evidenceConfidenceLevel: 'expertDesigned',
    comfortRiskLevel: 'low',
    expectedDurationMinutes: 12,
    stages: 11,
