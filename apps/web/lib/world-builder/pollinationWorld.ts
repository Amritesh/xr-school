  ...
  experienceDefinitions: [{
    ...
    stages: [
      ...
      },
      {
        ...
        title: 'Release the pollen',
        cue: 'Touch an anther and observe where its pollen begins.',
        requiredActionIds: ['release-pollen'],
        completionEvidenceIds: ['pollen-on-anther-observed'],
      },
      {
      ...
      {
        id: 'stage-seed-fruit',
        title: 'Inspect seed and fruit',
        cue: 'Open the comparison view and identify what the ovule and ovary become.',
        requiredActionIds: ['inspect-seed-fruit'],
        completionEvidenceIds: ['seed-fruit-change-observed'],
      },
      {
        id: 'stage-germination',
        title: 'Water the seed',
        cue: 'Add water and observe the first root and shoot directions.',
        requiredActionIds: ['water-seed'],
        completionEvidenceIds: ['germination-observed'],
      },
      {
        id: 'stage-mature-plant',
        title: 'Inspect the mature plant',
        cue: 'Find the new flower that can begin the cycle again.',
        requiredActionIds: ['inspect-mature-plant'],
