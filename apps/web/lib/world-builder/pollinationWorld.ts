...
export const POLLINATION_WORLD: WorldBundle = {
  world: {
    ...
    spatialLayoutId: 'spatial-pollination-garden',
  },
  entities: [
    {
      id: 'garden',
  ...
  scientificModels: [{
    ...
    limitations: [
      'The pistil, pollen tube, ovule, and germination cutaways are enlarged representational scientific views rather than literal garden scale',
      'The model compresses biological event duration into an authored classroom time lapse',
    ],
    referenceSources: [
  ...
  experienceDefinitions: [{
    id: 'experience-pollination-cycle',
    gradeTone: 'class6To8',
    objective: 'Perform and explain the journey from flower pollination to a new mature plant.',
    stages: [
      {
        id: 'stage-flower-garden',
        title: 'Inspect the flower',
        cue: 'Find the petals, pollen-bearing anthers, and pollen-receiving stigma.',
        requiredActionIds: ['inspect-flower'],
        completionEvidenceIds: ['flower-parts-identified'],
      },
      {
        id: 'stage-pollen-production',
        title: 'Collect a pollen sample',
        cue: 'Brush a mature anther and confirm that pollen adheres to the bristles.',
        requiredActionIds: ['collect-pollen'],
        completionEvidenceIds: ['pollen-collected-on-brush'],
      },
      {
        id: 'stage-pollinator-arrival',
        title: 'Observe the pollinator',
        cue: 'Follow the bee and notice which flower features attract it.',
        requiredActionIds: ['observe-pollinator'],
        completionEvidenceIds: ['bee-flower-visit-observed'],
      },
      {
      ...
      {
        id: 'stage-fertilisation',
        title: 'Trace the pollen tube',
        cue: 'Trace the route from the stigma through the style to the ovule.',
        requiredActionIds: ['trace-pollen-tube'],
        completionEvidenceIds: ['fertilisation-route-observed'],
      },
      {
        id: 'stage-seed-fruit',
        title: 'Compare treatment and control',
        cue: 'Advance the time lapse, then compare the pollinated flower with the untouched control.',
        requiredActionIds: ['advance-time-lapse', 'compare-control'],
        completionEvidenceIds: ['treatment-control-difference-observed'],
      },
      {
        id: 'stage-germination',
        title: 'Plant the resulting seed',
        cue: 'Open the fruit, plant and cover one seed, then add enough water.',
        requiredActionIds: [
          'open-fruit',
          'plant-seed',
          'cover-seed',
        ...
        completionEvidenceIds: ['germination-conditions-provided'],
      },
      {
        id: 'stage-mature-plant',
        title: 'Inspect germination',
        cue: 'Use the soil window to identify the radicle and plumule, then return to the mature plant.',
        requiredActionIds: ['inspect-germination'],
        completionEvidenceIds: ['cycle-completion-observed'],
      },
    ],
  }],
  spatialLayouts: [{
    id: 'spatial-pollination-garden',
    metersPerWorldUnit: 1,
    scaleRepresentation: 'literal',
    intendedEyeHeightMeters: 1.6,
    seatedEyeHeightMeters: 1.2,
    movementBoundsMeters: { width: 2.5, depth: 2.5 },
    reachMeters: { min: 0.25, max: 0.85 },
    cueBay: {
      position: [1.25, 1.45, -1.8],
      fallbackPositions: [[-1.25, 1.45, -1.8]],
    },
