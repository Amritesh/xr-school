#!/usr/bin/env python3
"""Generate the complete released-class portfolio report from audited data."""
...
def main() -> None:
    ...
    print(
        f"Generated {pages}-page portfolio report from {len(cards)} quality cards "
        f"and {len(scorecard['comparisons'])} contribution rows"
    )
